...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      clinics: {
        Row: {
          ...
          verification_status: Database["public"]["Enums"]["clinic_verification_status"]
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "clinics_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      posts: {
        ...
        Relationships: [
          {
            foreignKeyName: "posts_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
      ...
      reviews: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "reviews_call_log_id_fkey"
            columns: ["call_log_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      clinic_is_public: { Args: { p_clinic_id: string }; Returns: boolean }
    ...
    Enums: {
      ...
      appointment_status:
        ...
        | "cancelled"
        | "no_show"
      clinic_verification_status: "pending" | "approved" | "rejected"
      review_moderation_status:
        | "pending"
        | "approved_by_clinic"
        | "approved_by_admin"
        | "rejected"
      review_trigger_type: "call" | "appointment" | "qr_code"
      user_role: "admin" | "clinic_owner" | "client"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
