    ...
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <p className="text-stone-600 mb-6">
          Мы отправили ссылку-подтверждение на <strong>{email}</strong>. Откройте письмо и нажмите
          ссылку, чтобы активировать аккаунт.
        </p>
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      ...
      <p className="text-sm text-stone-500 mb-6">
        Создайте аккаунт пациента — сможете записываться на приём и оставлять отзывы.
      </p>
